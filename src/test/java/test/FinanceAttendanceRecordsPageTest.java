...
import ui.PageFinanceAttendanceRecords;
...
public class FinanceAttendanceRecordsPageTest {

    private PageFinanceAttendanceRecords page;

    @BeforeEach
    void setup() throws Exception {
        // Set session as Finance (U10011)
        SessionManager.setSession("U10011", 10011);
        SwingUtilities.invokeAndWait(() -> page = new PageFinanceAttendanceRecords());
    }
