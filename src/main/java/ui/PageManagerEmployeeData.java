...
public class PageManagerEmployeeData extends ui.base.AbstractProfilePage {

    public PageManagerEmployeeData() {
        initComponents();
    ...
    private void editProfileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editProfileButtonActionPerformed
        ...
        new PageManagerEmployeeDataUpdateProfile().setVisible(true);
        this.dispose(); // Close current page
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageManagerEmployeeData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
