...
public class PageFinanceEmployeeData extends ui.base.AbstractProfilePage {

    public PageFinanceEmployeeData() {
        initComponents();
    ...
    private void editProfileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editProfileButtonActionPerformed
        ...
        new PageFinanceEmployeeDataUpdateProfile().setVisible(true);
        this.dispose(); // Close current page
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageFinanceEmployeeData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
