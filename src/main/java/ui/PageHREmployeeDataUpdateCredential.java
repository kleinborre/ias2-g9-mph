...
public class PageHREmployeeDataUpdateCredential extends ui.base.AbstractUpdateCredentialPage {

    public PageHREmployeeDataUpdateCredential() {
        initComponents();

        // 1) Remove NetBeans-generated handlers so they don't fire
        ...
        // 2) Hook up the base-class password logic
        ...
        // 3) Populate the fields from currentUser/currentEmployee
        initializeUpdateCredentialPage();

        // 4) Wire Update / Cancel / Back to go back to **HR** page
        setButtons(
            updateButton,
            cancelButton,
            backButton,
        ...
        // 5) Unlock “Update” as soon as the user types anything
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageHREmployeeDataUpdateCredential.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
