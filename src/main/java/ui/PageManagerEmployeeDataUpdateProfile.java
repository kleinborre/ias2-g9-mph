...
public class PageManagerEmployeeDataUpdateProfile extends ui.base.AbstractUpdateProfilePage {

    public PageManagerEmployeeDataUpdateProfile() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageManagerEmployeeDataUpdateProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
