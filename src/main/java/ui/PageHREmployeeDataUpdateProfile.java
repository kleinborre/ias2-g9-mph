...
public class PageHREmployeeDataUpdateProfile extends ui.base.AbstractUpdateProfilePage {

    public PageHREmployeeDataUpdateProfile() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageHREmployeeDataUpdateProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
